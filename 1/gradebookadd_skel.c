  ...
  switch(R.action){
     ...
     case add_assignment:
        ...
        W_VALUE = atof(R.W_value);          
         //FIRST MAKE SURE THAT THE ASSIGNMENT DOES NOT ALREADY EXSIST
         while(ass_ptr != NULL){
         ...
         //reset the ass_ptr and checker_
     ...
     case add_student:
        ...
        LN_VALUE = R.LN_value;
         ...
         while(stu_ptr != NULL){
            //printf("%s %s \n",stu_ptr->first_name, stu_ptr->last_name);
            if((strcmp(stu_ptr->first_name,FN_VALUE)==0) && (strcmp(stu_ptr->last_name,LN_VALUE)==0)){
               printf("Invalid\n");
               checker_ = 1;
            }
         ...
         //reset the student pointer and checker
         stu_ptr = My_gradebook.students;
         checker_ = 0;
        ...
        //IF THE EXISISTANCE LINKED LIST IS NOT EMPTY, MAKE SURE THE STUDENT DOES NOT EXSIST
        while(stu_ptr->next != NULL){
           if(strcmp(stu_ptr->first_name,FN_VALUE)==0 && strcmp(stu_ptr->last_name,LN_VALUE)==0){
              printf("Invalid\n");
              checker_ = 1;
